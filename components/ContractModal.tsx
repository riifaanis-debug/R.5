              ...
              <div className="space-y-8 text-[15px] text-[#22042C] leading-[1.8]">
                ...
                <div className="space-y-10">
                  ...
                  <section>
                    ...
                    <p className="pr-4">يشمل التفويض الممنوح للطرف الأول الصلاحيات التالية : الاطلاع على التقارير الطبية والمستندات الرسمية، التواصل مع البنوك والجهات التمويلية، رفع الطلبات ومتابعتها، وإعداد المذكرات القانونية والحضور النظامي عند الحاجة.</p>
                  </section>

                  <section>
                    <h3 className="font-bold text-[16px] text-[#C5A059] mb-2">المادة (4): التزامات الطرف الأول</h3>
                    <p className="pr-4">يلتزم الطرف الأول بالمحافظة على سرية بيانات الطرف الثاني، بذل أقصى درجات العناية المهنية، رفع الطلبات بصيغة رسمية تعزز فرص القبول، وإبلاغ الطرف الثاني بالمستجدات دورياً.</p>
                  </section>
                  ...
                  <section>
                    ...
                    <p className="pr-4">لا تستحق أتعاب الطرف الأول إلا بعد صدور قرار الإعفاء النهائي وإصدار خطاب المخالصة المالية. وفي حال صدور القرار، يستحق الطرف الأول أتعاباً مقطوعة قدرها (4%) من إجمالي المبالغ المعفية فعلياً. وفي حال عدم قبول الطلب، لا يحق للطرف الأول المطالبة بأي أتعاب.</p>
                  </section>
        ...
        {isSuccess && (
          <div className="absolute inset-0 bg-white/90 backdrop-blur-sm flex items-center justify-center z-[200] animate-in fade-in duration-500">
            <div className="text-center p-10 max-w-sm">
              ...
              <h3 className="text-[24px] font-black text-[#22042C] mb-3 font-['Tajawal']">تم التوقيع بنجاح</h3>
              <p className="text-[14px] text-muted leading-relaxed font-['Tajawal']">
